...
Fuente: [IBM España](https://www.ibm.com/es-es/topics/business-intelligence)  
_Copia local para lectura fuera de línea. El formato original puede verse en la URL._

---

¿Qué es la inteligencia empresarial (BI)? | IBM 
...
El flujo de trabajo de la BI, desde las fuentes de datos y la recopilación hasta los planes de acción basados en información
...
Garantizar el acceso a los datos a los responsables de la toma de decisiones : muchas empresas están rezagadas. Los datos esenciales no se capturan ni analizan de manera suficiente, según un informe de IDC 4 que estima que hasta el 68 % de los datos empresariales se malgastan. Las empresas con una  arquitectura de datos moderna  y una sólida adopción de BI disfrutan de una ventaja competitiva: están posicionadas para avanzar aún más adoptando prácticas de  toma de decisiones en tiempo real  y análisis predictivos.
...
El North York General Hospital utiliza IBM Cognos Analytics

Vea cómo el North York General Hospital mejora la atención y asegura la financiación mediante el uso de conocimientos basados en datos.
