# Herramientas y soluciones de visualización de datos

Fuente: [IBM México](https://www.ibm.com/mx-es/analytics/data-visualization)  
_Copia local para lectura fuera de línea. El formato original puede verse en la URL._

---

¿Qué es la visualización de datos? | IBM 
...
Es una biblioteca JavaScript front-end para producir visualizaciones de datos dinámicas e interactivas en navegadores web.  D3.js emplea HTML, CSS y SVG para crear representaciones visuales de datos que se pueden ver en cualquier navegador. También proporciona características para interacciones y animaciones.
...
Una potente biblioteca de gráficos y visualización que ofrece una manera sencilla de añadir gráficos intuitivos, interactivos y altamente personalizables a productos, trabajos de investigación, presentaciones, etc.  Echarts (enlace externo a ibm.com) se basa en JavaScript y ZRender, una biblioteca de lienzo ligera.
...
Vega se define a sí misma como “gramática de visualización”, que brinda soporte para personalizar visualizaciones en grandes conjuntos de datos a los que se puede acceder desde la web.
...
Es parte de la suite de marcos de visualización de código abierto de Uber.  deck.gl es una infraestructura, que se emplea para el análisis exploratorio de datos sobre big data. Ayuda a crear una visualización de alto rendimiento impulsada por GPU en la web.
...
Descubra por qué tener total libertad para elegir lenguajes, herramientas y marcos de programación mejora el pensamiento creativo y la evolución.
...
Explorar los servicios de analytics
